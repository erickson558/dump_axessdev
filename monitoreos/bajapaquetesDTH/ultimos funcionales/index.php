...
<body>
      ...
      <div class="col-lg-10">
        <div class="card shadow-lg mb-5">
          <div class="card-header bg-primary text-white py-3">
            <h3 class="mb-0"><i class="fas fa-paper-plane me-2"></i>Envío Masivo de Bajas HFC CENAM XML SOAP</h3>
          </div>
            ...
            <form id="formulario" action="procesar.php" method="POST" enctype="multipart/form-data" target="iframe_oculto">
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <small class="text-muted">Formato requerido: ServiceID, MacAddress</small>
                </div>
                
                <div class="col-md-6">
                  <label class="form-label fw-bold">4. Seleccione un País:</label>
                ...
                <!-- ...dentro de tu row g-3, después de Tiempo entre peticiones -->
				<div class="col-md-6">
				...
				<select name="threads" class="form-select">
					...
					<option value="10" selected>10 hilos</option>
        ...
        <div class="card shadow mb-4" id="progress-card" style="display: none;">
          <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <div>
              <button type="button" onclick="iniciarEnvio()" id="start-btn" class="btn btn-success btn-sm me-2 btn-action">
  ...
  <script>
    ...
    function iniciarEnvio() {
	  console.log('🔥 iniciarEnvio disparado');
