                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="file-upload-container">
                                        ...
                                        <h4>Archivo PROD</h4>
                                        <p><strong>Paso 1</strong> ejecutar el comando bootloader.py node status -H node-1>edaPROD.txt</p>
										<p><strong>Paso 2</strong> moverlo el archivo generado al FTP</p>
										<p><strong>Paso 3</strong> bajarlo a PC local y cargarlo para su análisis</p>
                                ...
                                <div class="col-md-6">
                                    <div class="file-upload-container">
                                        ...
                                        <h4>Archivo STBY</h4>
                                        <p><strong>Paso 1</strong> ejecutar el comando bootloader.py node status -H node-1>edaSTBY.txt</p>
										<p><strong>Paso 2</strong> moverlo el archivo generado al FTP</p>
										<p><strong>Paso 3</strong> bajarlo a PC local y cargarlo para su análisis</p>
										<p class="text-muted">Selecciona el archivo de respaldo</p>
                                        <div class="form-group">
