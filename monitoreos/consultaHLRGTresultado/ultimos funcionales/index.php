...
<head>
  ...
  <style>
    ...
    .console-message { padding: 3px 0; border-bottom: 1px solid rgba(255,255,255,0.1); }
    ...
    .theme-toggle:hover { transform: scale(1.1); box-shadow: 0 4px 15px rgba(0,0,0,0.3); }

    #estimated-time-value { font-weight: bold; margin-left: 5px; }
    .estimated-time { margin-bottom: 15px; font-size: 14px; }
...
<body>
      ...
      <div class="col-lg-10">
        <div class="card shadow-lg mb-5">
          <div class="card-header bg-primary text-white py-3">
            <h3 class="mb-0"><i class="fas fa-satellite-dish me-2"></i>Envío Masivo de Create FNR PT3 Móvil GT XML SOAP EPAP</h3>
          </div>
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <select name="endpoint" id="endpoint_select" class="form-select" required>
                    ...
                    <option value="http://172.20.190.94:8080/CAI3G1.2/services/CAI3G1.2/async">EDAGT - Guatemala</option>
                  </select>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <input type="password" name="contrasena" class="form-control" required placeholder="Contraseña SOAP">
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <small class="text-warning form-label fw-bold">Formato requerido: <code>msisdn,imsi</code> (sin encabezado). Ejemplo: <code>50254618207,704012052549215</code></small>
                </div>

                <!-- CAMBIO 1: Combobox para delay -->
                <div class="col-md-6">
  ...
  <script>
    ...
    let delayMs = 1000; // valor por defecto, se sincroniza con el combo al cargar
    ...
    function actualizarDelay(valor) {
      delayMs = parseInt(valor, 10) || 1000;
      calcularTiempoFinalizacion();
    }
    ...
    // Si en algún momento agregas "otro" endpoint, puedes reutilizar esto:
    function toggleCustomEndpoint() {
      const sel = document.getElementById("endpoint_select");
      const custom = document.getElementById("endpoint_custom"); // si existiera
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      // Sincroniza delayMs con el combo
      const delaySelect = document.querySelector('select[name="delay"]');
      if (delaySelect) actualizarDelay(delaySelect.value);

      // Inicializa barra de progreso
      document.getElementById('progress-bar').style.width = '0%';
    });

    // Exponer funciones que usa el backend vía iframe (si corresponde)
