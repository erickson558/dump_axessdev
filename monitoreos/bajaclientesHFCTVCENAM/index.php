      ...
      <div class="col-lg-10">
        <div class="card shadow-lg mb-5">
          <div class="card-header bg-primary text-white py-3">
            <h3 class="mb-0"><i class="fas fa-satellite-dish me-2"></i>Envío Masivo de Bajas Clientes HFC TV CENAM XML SOAP</h3>
          </div>
            ...
            <form id="formulario" action="procesar.php" method="POST" enctype="multipart/form-data" target="iframe_oculto">
              <div class="row g-3">
                ...
                <div class="col-md-6">
				  ...
				  <small class="text-warning form-label fw-bold">Formato requerido: Serial</small>
				</div>
