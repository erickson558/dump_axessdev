      ...
      <div class="col-lg-10">
        <div class="card shadow-lg mb-5">
          <div class="card-header bg-primary text-white py-3">
            <h3 class="mb-0"><i class="fas fa-satellite-dish me-2"></i>Envío Masivo de Bajas Telefonía e Internet HFC CENAM XML SOAP</h3>
          </div>
          <div class="card-body p-4">
            <form id="formulario" action="procesar.php" method="POST" enctype="multipart/form-data" target="iframe_oculto">
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  <label class="form-label fw-bold">3. Seleccione el país:</label>
                ...
                <div class="col-md-6">
                  <label class="form-label fw-bold">4. Seleccione un Archivo (.csv,.txt):</label>
                  <input type="file" name="archivo" class="form-control" required accept=".csv,.txt">
                  <small class="text-warning form-label fw-bold">Formato requerido: ServiceID, MACADDRESS</small>
                </div>
                
                <div class="col-md-6">
                  <label class="form-label fw-bold">Tiempo entre peticiones (ms):</label>
                  <input type="number" name="delay" class="form-control" value="300" min="100" step="100" onchange="actualizarDelay(this.value)">
                </div>
                <div class="col-md-12">
                  <label class="form-label fw-bold">5. Seleccione el/los servicio(s):</label>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="service-internet" name="services[]" value="Internet" checked>
                    <label class="form-check-label" for="service-internet">Internet</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="service-voice" name="services[]" value="Voice" checked>
                    <label class="form-check-label" for="service-voice">Voice</label>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <select name="threads" class="form-select">
                    ...
                    <option value="5" selected>5 hilos</option>
